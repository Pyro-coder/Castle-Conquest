...
namespace BattleSheepCore.Board
{
	...
	public class BoardManager
	{
		...
		// Create a deep copy of the BoardManager.
		public BoardManager Clone()
		{
			var clone = new BoardManager(this.size)
			{
				_isFirstPlacement = this._isFirstPlacement
			};

			// Clone each cell.
			clone._board = new Dictionary<(int, int), HexCell>();
			foreach (var kvp in this._board)
			{
				clone._board[kvp.Key] = kvp.Value.Clone();
			}

			// If you have collections like _placedTiles and _stacks,
